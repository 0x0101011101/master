...
public class TemperatureView extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		//canvas.drawText(getContext().getString(R.string.temperature_value,String.valueOf(currentTemperature)), availableWidth / 10, availableHeight / 10, textPaint);
		canvas.drawText(String.valueOf(currentTemperature), availableWidth / 10, availableHeight / 10, textPaint);
	}
}