...
public class ProjectTenActivity extends Activity {
	...
	private static final String ACTION_USB_PERMISSION = "com.m2m.projectten.action.USB_PERMISSION";
	...
	private static final byte MOVE_FORWARD = 0x1;
	private static final byte MOVE_BACKWARD = 0x2;
	
	// UI elements initialization
	private Button xr_axis_button;
	private Button xl_axis_button;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		xr_axis_button = (Button) findViewById(R.id.xr_axis_button);
		xr_axis_button.setOnClickListener(ButtonClickListener);
		
		xl_axis_button = (Button) findViewById(R.id.xl_axis_button);
		xl_axis_button.setOnClickListener(ButtonClickListener);
	}
	...
	OnClickListener ButtonClickListener = new OnClickListener() {
		...
		public void onClick(View buttonView) {
			...
			if (buttonView.getId()==R.id.xr_axis_button) {
				new AsyncTask<Integer, Void, Void>(){

					@Override
					protected Void doInBackground(Integer... params) {
						moveServoCommand(SERVO_ID_1, MOVE_FORWARD);
						return null;
					}
			...
			if (buttonView.getId()==R.id.xl_axis_button) {
				new AsyncTask<Integer, Void, Void>(){

					@Override
					protected Void doInBackground(Integer... params) {
						moveServoCommand(SERVO_ID_1, MOVE_BACKWARD);
						return null;
					}
	...
	// Move SERVO MOTOR
	public void moveServoCommand(byte target, byte value) {
