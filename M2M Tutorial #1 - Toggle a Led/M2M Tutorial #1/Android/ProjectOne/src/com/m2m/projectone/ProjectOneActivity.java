...
public class ProjectOneActivity extends Activity {
	...
	private static final String ACTION_USB_PERMISSION = "com.m2m.projectone.action.USB_PERMISSION";
	...
	// The only user-visible UI elements is a ToggleButton, which should ON/OFF a LED plugged on the Arduino Board
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Display main content including a ToggleButton and its listener 
	...
	// The Toggle Button Listener manage the Android UI "checked" status of the Toggle Button and send it to LED through sendLedSwitchCommand method 
