...
public class ProjectElevenActivity extends Activity {
	...
	private static final String ACTION_USB_PERMISSION = "com.m2m.projecteleven.action.USB_PERMISSION";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		motorSpeedTextView = (TextView) findViewById (R.id.motor_intensity_text_view);
		motorSpeedSeekBar = (SeekBar) findViewById(R.id.motor_intensity_seek_bar);
		motorSpeedSeekBar.setOnSeekBarChangeListener(motorSpeedChangeListener);
		motorSpeedTextView.setText("DC MOTOR Speed : " + motorSpeedSeekBar.getProgress());
	}
	...
	OnSeekBarChangeListener motorSpeedChangeListener = new OnSeekBarChangeListener() {
		...
		public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
			...
			new AsyncTask<Byte, Void, Void> () {
				...
				protected Void doInBackground(Byte... params) {
					moveMotorCommand(DC_MOTOR_ID_1, params[0]);
					return null;
				}
