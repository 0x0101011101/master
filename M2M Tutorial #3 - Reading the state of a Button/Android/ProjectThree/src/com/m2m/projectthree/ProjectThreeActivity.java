...
public class ProjectThreeActivity extends Activity {
	...
	private static final String ACTION_USB_PERMISSION = "com.m2m.projectthree.action.USB_PERMISSION";
	...
	// The only user-visible UI elements is a TextView which should display the button status from the Arduino Board
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Display main content including a TextView for Switch status - Activation of vibrator 
	...
	// Thread which manage buffer input from Switch on Arduino board, activate Android vibrator and display Switch text status
