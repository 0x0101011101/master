...
public class ProjectSixActivity extends Activity {
	...
	private static final String ACTION_USB_PERMISSION = "com.m2m.projectsix.action.USB_PERMISSION";
	...
	// The only user-visible UI elements is a LinearLayout which change its background color randomly
	// and a ProgressBar
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Display main content including a ProgressBar and its listener
						...
						if(buffer[1] == TARGET_PIN) {
							...
							runOnUiThread (new Runnable() {
								...
								public void run() {
									...
									adcValueTextView.setText(String.valueOf(adcValue));
